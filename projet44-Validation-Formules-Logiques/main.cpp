     ...
     XOROR(slog1);
       // std::cout<<"oui continue\n";
         ...
         OROR(slog1);
          ...
          XORANDOR(slog2);
         } else if(Tvar==4&&v1=="AND"&&v2=="OR"&&v3=="AND"){
          ANDORAND(slog2);
         } else if(Tvar==4&&v1=="XoR"&&v2=="OR"&&v3=="XoR"){
          XORORXOR(slog2);
         }else if(Tvar==4&&v1=="OR"&&v2=="AND"&&v3=="OR"){
          ORANDOR(slog2);
         }else if(Tvar==4&&v1=="XoR"&&v2=="AND"&&v3=="XoR"){
          XORANDXOR(slog2);
         }else if(Tvar==4&&v1=="AND"&&v2=="XoR"&&v3=="AND"){
          ANDXORAND(slog2);
         }else if(Tvar==4&&v1=="OR"&&v2=="XoR"&&v3=="OR"){
          ORXOROR(slog2);
         }
